...
#------------Path of the images --------------------------------------------------------------
#train
original_imgs_train = "./Ophtha_EX/train/images/"
groundTruth_imgs_train = "./Ophtha_EX/train/labels/"
borderMasks_imgs_train = "./Ophtha_EX/train/mask/"
#test
original_imgs_test = "./Ophtha_EX/test/img/"
groundTruth_imgs_test = "./Ophtha_EX/test/lbl/"
borderMasks_imgs_test = "./Ophtha_EX/test/mask/"
#---------------------------------------------------------------------------------------------
...
def get_datasets(imgs_dir, groundTruth_dir, borderMasks_dir, train_test="null"):
    ...
    for path, subdirs, files in os.walk(imgs_dir): #list all files, directories in the path
        for i in range(len(files)):
            ...
            groundTruth_name = files[i][0:8] + "_EX.png"
            ...
            border_masks_name = ""
            if train_test=="train":
                border_masks_name = files[i][0:8] + "_mask.tif"
...
write_hdf5(border_masks_test,dataset_path + "borderMasks_test.hdf5")
