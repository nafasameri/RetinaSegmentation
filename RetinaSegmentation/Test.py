...
class Test(object):
    ...
    def __init__(self, channels, height, width, img_dir, borderMasks_dir, dataset_path = "./dataset_training/"):     
        self.channels = channels
        self.height = height
        self.width = width
        self.img_dir = img_dir
        self.borderMasks_dir = borderMasks_dir
        self.dataset_path = dataset_path
        self.img = np.empty((height,width,channels))
        self.border_mask = np.empty((height,width))
    ...
    def testing(self, fileName):
        img, border_mask = get_data(original_imgs_train, borderMasks_imgs_train)
        print ("saving train datasets")
        write_hdf5(img, dataset_path + "imgs_train.hdf5")
        write_hdf5(border_mask, dataset_path + "borderMasks_train.hdf5")
